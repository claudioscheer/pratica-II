...
public class Recgrauensino_1 implements Serializable {
    ...
    public Recgrauensino_1() {
    }

    public Recgrauensino_1(Integer greId) {
        this.greId = greId;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Recgrauensino_1)) {
            return false;
        }
        Recgrauensino_1 other = (Recgrauensino_1) object;
