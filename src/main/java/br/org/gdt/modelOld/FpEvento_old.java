...
public class FpEvento_old implements java.io.Serializable {
    @Id
...
//    }
//
//    public FpEvento_old(Integer eveId) {
//        this.eveId = eveId;
//    }
//
//    public FpEvento_old(Integer eveId, boolean eveEventovariavel, long eveid, boolean eveativo, boolean eveeventovariavel) {
//        this.eveId = eveId;
//        this.eveEventovariavel = eveEventovariavel;
//        this.eveid = eveid;
//        this.eveativo = eveativo;
...
//        if (!(object instanceof FpEvento_old)) {
//            return false;
//        }
//        FpEvento_old other = (FpEvento_old) object;
